...
from utils.mixup_utils import (
    get_index_randomly,
    get_index_disjointly,
    get_indices_balancely,
)
...
def main_worker(rank, world_size, args):
    ...
    trainsampler = custom_dataset.DistributedMixIndexSampler(
        custom_dataset.MixIndexDataset(train_set), mix_index_func=get_indices_balancely)
    ...
    trainloader = DataLoader(
        custom_dataset.MixIndexDataset(train_set),
