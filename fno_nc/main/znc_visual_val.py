...
def main_worker(rank, world_size, args):
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        if (cfg.valid_step != -1) and (epoch % cfg.valid_step == 0):
            total_features, total_labels, valid_acc, valid_loss, lt_acc = valid_model(
